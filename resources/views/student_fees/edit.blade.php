                    ...
                    <div class="row">
                        <div class="col-sm col-6">
                            <div class="form-group">
                                ...
                                <select name="class_id" class="form-control class_id" id="InputClassId" readonly >
                            ...
                            <div class="form-group">
                                ...
                                <select name="academic_year_id" class="form-control academic_year" id="InputAcademicYearId" readonly>
                                <option value=''>{{__('display.student.placeholder.class')}}</option>
                                </select>
                                <span class="alert-danger"></span>
                            </div>
