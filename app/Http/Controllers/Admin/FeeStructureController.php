...
class StudentFeeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $user_data['status'] = 1;
        $user = $userobj->SaveUser($user_data);
        ...
        $student = $studentobj->SaveStudent($student_data);
    ...
    public function edit($id)
    {
        ...
        if($id)
        {
            ...
            if(isset($data['id']))
            {
                return view('student_fees.edit',['data' => $data]);
            }
            else
            {
    ...
    public function update(Request $request, $id)
    {
        ...
        if($id)
        {
            ...
            $getstudentobj = new Student();
            $data = $getstudentobj->GetStudent($id);
            ...
            $user_data['date_of_join'] = date('Y-m-d',strtotime($request->doj));
            $user_data['status'] = 1;
            $user = $userobj->SaveUser($user_data,$data['user_id']);
            ...
            $student_data['current_address'] = $request->current_address;
            $student_data['reg_number'] = Helper::getRegistrationCode($user->id);
            $student = $studentobj->SaveStudent($student_data,$data['id']);
